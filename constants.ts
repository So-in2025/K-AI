...
export const EPIC_QUOTES: IQuote[] = [
    { text: "El obstáculo es el camino.", author: "Marco Aurelio", tags: ['addiction', 'depression'] },
    { text: "No se nos da una vida corta, sino que la acortamos. No somos indigentes, sino que la malgastamos.", author: "Séneca", tags: ['addiction'] },
    { text: "Aquel que tiene un porqué para vivir se puede enfrentar a todos los 'cómos'.", author: "Friedrich Nietzsche", tags: ['depression', 'grief'] },
    { text: "El hombre que se levanta es más grande que el que no ha caído.", author: "Concepción Arenal", tags: ['addiction'] },
    { text: "La herida es el lugar por donde la luz entra en ti.", author: "Rumi", tags: ['grief', 'depression'] },
    { text: "No soy lo que me ha pasado, soy lo que elijo ser.", author: "Carl Jung", tags: ['depression', 'grief'] },
    { text: "La única persona en la que estás destinado a convertirte es la persona que decides ser.", author: "Ralph Waldo Emerson" },
    { text: "El secreto del cambio es enfocar toda tu energía, no en luchar contra lo viejo, sino en construir lo nuevo.", author: "Sócrates", tags: ['addiction'] },
    { text: "Entre el estímulo y la respuesta hay un espacio. En ese espacio reside nuestro poder de elegir nuestra respuesta. En nuestra respuesta yace nuestro crecimiento y nuestra libertad.", author: "Viktor Frankl", tags: ['addiction', 'depression'] },
    { text: "La vida se encoge o se expande en proporción a tu coraje.", author: "Anaïs Nin", tags: ['depression'] },
    { text: "Un viaje de mil millas comienza con un solo paso.", author: "Lao Tzu" },
    { text: "Lo que no me mata, me hace más fuerte.", author: "Friedrich Nietzsche", tags: ['addiction', 'grief'] },
    { text: "La felicidad no es algo ya hecho. Viene de tus propias acciones.", author: "Dalai Lama" },
    { text: "El dolor es inevitable. El sufrimiento es opcional.", author: "Haruki Murakami", tags: ['grief', 'depression'] },
    { text: "La buena vida es un proceso, no un estado del ser. Es una dirección, no un destino.", author: "Carl Rogers" },
    { text: "Una vida no examinada no merece ser vivida.", author: "Sócrates" },
    { text: "No podemos cambiar las cartas que se nos reparten, solo cómo jugamos la mano.", author: "Randy Pausch", tags: ['grief'] },
    { text: "El arte de vivir es más como luchar que como bailar.", author: "Marco Aurelio" },
    { text: "Cae siete veces, levántate ocho.", author: "Proverbio Japonés", tags: ['addiction'] },
    { text: "La libertad no es la ausencia de compromisos, sino la capacidad de elegir - y comprometerme - con lo que es mejor para mí.", author: "Paulo Coelho" },
    { text: "No vemos las cosas como son, las vemos como somos.", author: "Anaïs Nin" },
    { text: "La curiosidad sobre la vida en todos sus aspectos, creo, sigue siendo el secreto de los grandes creativos.", author: "Leo Burnett" },
    { text: "Sé tú mismo; todos los demás ya están ocupados.", author: "Oscar Wilde" },
    { text: "Todo lo que siempre has querido está al otro lado del miedo.", author: "George Addair", tags: ['depression'] },
    { text: "La mente lo es todo. En lo que piensas, te conviertes.", author: "Buda" },
    { text: "El éxito es la suma de pequeños esfuerzos repetidos día tras día.", author: "Robert Collier", tags: ['addiction'] },
    { text: "El que conquista a otros es fuerte; el que se conquista a sí mismo es poderoso.", author: "Lao Tzu" },
    { text: "La mejor época para plantar un árbol fue hace 20 años. La segunda mejor época es ahora.", author: "Proverbio Chino" },
    { text: "No juzgues cada día por la cosecha que recoges, sino por las semillas que plantas.", author: "Robert Louis Stevenson" },
    { text: "Tu tarea no es buscar el amor, sino simplemente buscar y encontrar todas las barreras dentro de ti que has construido contra él.", author: "Rumi", tags: ['grief', 'depression'] },
    { text: "Lo que se interpone en el camino se convierte en el camino.", author: "Marco Aurelio", tags: ['addiction', 'depression'] },
    { text: "No te tomes nada personalmente. Nada de lo que los demás hacen es por ti. Lo que los demás dicen y hacen es una proyección de su propia realidad, de su propio sueño.", author: "Don Miguel Ruiz" },
    { text: "Si quieres levantar a los demás, primero debes levantarte a ti mismo.", author: "Booker T. Washington" },
    { text: "La mente es como un paracaídas. No funciona si no se abre.", author: "Frank Zappa" },
    { text: "El carácter no se puede desarrollar en la facilidad y la tranquilidad. Solo a través de la experiencia de la prueba y el sufrimiento se puede fortalecer el alma, inspirar la ambición y alcanzar el éxito.", author: "Helen Keller", tags: ['grief'] },
    { text: "Sé el cambio que deseas ver en el mundo.", author: "Mahatma Gandhi" },
    { text: "La preocupación no vacía el mañana de sus penas, vacía el hoy de su fuerza.", author: "Corrie ten Boom", tags: ['depression'] },
    { text: "La única sabiduría verdadera es saber que no sabes nada.", author: "Sócrates" },
    { text: "La paciencia es amarga, pero su fruto es dulce.", author: "Aristóteles", tags: ['addiction'] },
    { text: "Un hombre es sino el producto de sus pensamientos. En lo que piensa, se convierte.", author: "Mahatma Gandhi" },
    { text: "El universo está hecho de historias, no de átomos.", author: "Muriel Rukeyser" },
    { text: "Somos lo que hacemos repetidamente. La excelencia, entonces, no es un acto, sino un hábito.", author: "Will Durant" },
    { text: "La amabilidad es el lenguaje que los sordos pueden oír y los ciegos pueden ver.", author: "Mark Twain" },
    { text: "No es la carga lo que te destroza, es la forma en que la llevas.", author: "Lou Holtz", tags: ['grief', 'depression'] },
    { text: "La resiliencia se trata de cómo te recargas, no de cómo aguantas.", author: "Shawn Achor", tags: ['depression'] },
    { text: "El autoconocimiento no tiene fin. No llegas a un logro, no llegas a una conclusión. Es un río sin fin.", author: "Jiddu Krishnamurti" },
    { text: "La paz interior comienza en el momento en que eliges no permitir que otra persona o evento controle tus emociones.", author: "Pema Chödrön", tags: ['depression'] },
    { text: "La ansiedad es la prima del pensamiento excesivo. Es pensar demasiado, demasiado pronto, sobre demasiadas cosas.", author: "Anónimo", tags: ['depression'] },
