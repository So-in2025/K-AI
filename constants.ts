...
export const EPIC_QUOTES: IQuote[] = [
    ...
    { text: "El carácter no se puede desarrollar en la facilidad y la tranquilidad. Solo a través de la experiencia de la prueba y el sufrimiento se puede fortalecer el alma, inspirar la ambición y alcanzar el éxito.", author: "Helen Keller" },
    { text: "Sé el cambio que deseas ver en el mundo.", author: "Mahatma Gandhi" },
    { text: "La preocupación no vacía el mañana de sus penas, vacía el hoy de su fuerza.", author: "Corrie ten Boom" },
    ...
    { text: "No es la carga lo que te destroza, es la forma en que la llevas.", author: "Lou Holtz" },
    { text: "La resiliencia se trata de cómo te recargas, no de cómo aguantas.", author: "Shawn Achor" },
    ...
    { text: "La paz interior comienza en el momento en que eliges no permitir que otra persona o evento controle tus emociones.", author: "Pema Chödrön" },
    { text: "La ansiedad es la prima del pensamiento excesivo. Es pensar demasiado, demasiado pronto, sobre demasiadas cosas.", author: "Anónimo" },
