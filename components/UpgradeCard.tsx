    ...
    return (
        <div className="bg-gradient-to-br from-slate-700 to-slate-800 p-6 rounded-2xl shadow-lg border border-teal-500/50">
            <div className="text-center">
                <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-teal-300 to-cyan-400">Activa KIA Plus para Desbloquear tu Potencial</h2>
                <p className="text-slate-300 mt-2 text-sm max-w-xl mx-auto">
                    KIA es un proyecto sostenible que requiere recursos para su mantenimiento y mejora. Al activar KIA Plus, no solo obtienes nuestras herramientas más avanzadas, sino que aseguras que este espacio seguro siga creciendo y ayudando a más personas.
                </p>
            </div>
            
            <div className="mt-6 text-center">
                <p className="text-slate-200 font-semibold">Tu acceso a KIA Plus incluye:</p>
            </div>
            ...
            >
                <BrainIcon />
                <span className="ml-2">Activar KIA Plus Ahora</span>
            </button>
        </div>
    );
};
